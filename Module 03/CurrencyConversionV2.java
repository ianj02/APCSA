...
public class CurrencyConversionV2
{
    public static void main(String [ ] args)
    {
        ...
        //user input for peso exchange rate
        Scanner pesoIn;
        pesoIn = new Scanner(System.in);
        System.out.println("Enter Peso exchange rate:   ");
        pesoExchangeRate = pesoIn.nextDouble();

        // conversion for Mexican pesos
        remainingUsDollarsMX = pesosSpent / pesoExchangeRate;
            
        //user input for yen exchange rate
        Scanner yenIn;
        yenIn = new Scanner(System.in);
        System.out.println("Enter Yen exchange rate:    ");
        yenExchangeRate = yenIn.nextDouble();
        
        // convesion for Japanese yen
        remainingUsDollarsJP = yenSpent / yenExchangeRate;
        
        //user input for euro exchang rate
        Scanner euroIn;
        euroIn = new Scanner(System.in);
        System.out.println("Enter Euro exchange rate:    ");
        euroExchangeRate = euroIn.nextDouble();
